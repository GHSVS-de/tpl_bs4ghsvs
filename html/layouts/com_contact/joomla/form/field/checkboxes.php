 ...
 */
$format = '<input type="checkbox" class="checkbox ' . $class . '" id="%1$s" name="%2$s" value="%3$s" %4$s />';

// The alt option for JText::alt
$alt = preg_replace('/[^a-zA-Z0-9_\-]/', '_', $name);
?>

<fieldset id="<?php echo $id; ?>" class="checkboxes"
...
<?php echo $option->text; ?><?php echo sprintf($format, $oid, $name, $value, implode(' ', $attributes)); ?>  
	<?php endforeach; ?>
</fieldset>
