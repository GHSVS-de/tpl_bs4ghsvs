...
<body>
    ...
    <p><strong><?php 
				...
				// not translated?
				if (JText::_($ownStr) == $ownStr)
				{
					$ownStr = 'JERROR_LAYOUT_NOT_ABLE_TO_VISIT';
				}
				echo JText::_($ownStr); ?></strong></p>
    <p class="errorMessage">
			...
			<p><strong><?php 
				...
				echo JText::sprintf($ownStr, JUri::root()); ?><br>

<a href="<?php echo JUri::root(); ?>" title="<?php echo JText::_('JERROR_LAYOUT_GO_TO_THE_HOME_PAGE'); ?>"><?php echo JText::_('JERROR_LAYOUT_HOME_PAGE'); ?></a>
</strong></p>
<p>&nbsp;</p>
			<p><?php 
				...
				echo JText::sprintf($ownStr,
				 JUri::getInstance()->toString(),
					($erroremail ? JHtml::_('email.cloak', $erroremail) : '')
				);?></p>
			<div id="techinfo">
